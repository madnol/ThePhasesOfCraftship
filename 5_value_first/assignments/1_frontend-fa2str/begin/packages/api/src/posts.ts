...
export namespace API {
  ...
  export type GetPostDetailsResponse = APIResponse<DTOs.PostDTO, Errors.GetPostDetailsError>;
...
export const createPostsAPI = (apiURL: string) => {
  ...
  return {
    ...
    getPostBySlug: async (slug: string): Promise<API.GetPostByIdAPIResponse> => {
      try {
