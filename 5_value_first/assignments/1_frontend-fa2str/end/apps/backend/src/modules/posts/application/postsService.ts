...
import { GetPostBySlug } from "./useCases/getPostBySlug/getPostBySlug";
...
export class PostsService {
  ...
  async getPostBySlug(slug: string) {
    const getPostBySlug = new GetPostBySlug(this.postsRepo);
    return await getPostBySlug.execute(slug);
  }
}
