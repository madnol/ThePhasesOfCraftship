...
export class CommentVote extends AggregateRoot {
  ...
  private upvote() {
    ...
    this.domainEvents.push(CommentUpvoted.create({ commentId: this.commentId, memberId: this.memberId }));
  }
  ...
  private downvote() {
    ...
    this.domainEvents.push(CommentDownvoted.create({
  ...
  public static create (memberId: string, commentId: string) : CommentVote {
  ...
  public static createUpvote(memberId: string, commentId: string): CommentVote {
    return new CommentVote({
      id: randomUUID(),
      memberId: memberId,
      commentId: commentId,
  ...
  public static createDownvote(memberId: string, commentId: string): CommentVote {
    return new CommentVote({
      id: randomUUID(),
      memberId: memberId,
      commentId: commentId,
